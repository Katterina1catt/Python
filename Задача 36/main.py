...
# (подумайте, почему не с нуля). Примечание: бинарной операцией называется 
# любая операция, у которой ровно два аргумента, как, например, у операции 
# умножения.
# *Пример:*
...
def print_operation_table(operation, num_rows=6, num_columns=6):
    # Создаем двумерный список для хранения элементов таблицы
